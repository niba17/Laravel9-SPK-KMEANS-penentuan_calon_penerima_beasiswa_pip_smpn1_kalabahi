    ...
    <body>
        ...
        <header id="header" class="fixed-top">
            <div class="container d-flex align-items-center">
                ...
                <h1 class="logo me-auto"><a href="/">SPK | K-MEANS</a></h1>
        ...
        <section id="hero" class="d-flex align-items-center">
            <div class="container">
                ...
                <h2 class="col-lg-12 col-sm-12 text-light text-center fw-bold" style="font-size:30px;">SISTEM PENDUKUNG
                    KEPUTUSAN
                    PENENTUAN CALON PENERIMA BEASISWA
                    PROGRAM INDONESIA PINTAR (PIP) DENGAN IMPLEMENTASI
                    ALGORITMA <br>K-MEANS
                    DI SMP NEGERI 1 KALABAHI BERBASIS WEB
                </h2>
                    ...
                    <div class="row">
                        <div class="col-lg-12 d-flex align-items-stretch">
                            <div class="content">
                                ...
                                <p class="text-center">
                                    Beasiswa adalah salah satu program yang direncanakan untuk mengatasi rendahnya kualitas
                                    sumber daya manusia dari sisi proses pendidikan, selain itu beasiswa juga merupakan
                                    bantuan biaya yang diberikan pemerintah yang peduli pada proses pendidikan agar
                                    masyarakat terlepas dari kesulitan pemenuhan biaya pendidikan (Saroni & Ratri, 2013).
                                    Beasiswa merupakan pemberian berupa bantuan keuangan yang diberikan kepada perorangan
                                    yang bertujuan untuk digunakan demi keberlangsungan pendidikan yang ditempuh (Putranto,
                                    2011). SMP Negeri 1 Kalabahi merupakan lembaga pendidikan yang memberikan beasiswa,
                                    salah satunya adalah beasiswa Program Indonesia Pintar (PIP) yang merupakan bantuan
                                    untuk siswa yang tidak mampu. Pada tahun 2020 kuota PIP untuk SMP Negeri 1 Kalabahi
                                    sejumlah 110 dengan jumlah siswa 271 siswa. Dalam beasiswa PIP ini, pada proses
                                    pengelompokan yang menjadi kriteria mendapatkan beasiswa PIP siswa yang tidak mampu.
                                </p>
